...
var init = () => {
    ...
    }
    {
        ...
        alpha.getDescription = (_) => "\alpha = " + getAlpha(alpha.level).toFixed(2);
        alpha.getInfo = (amount) => "\alpha: " + getAlpha(alpha.level).toFixed(2) + " → " + getAlpha(alpha.level + amount).toFixed(2);
    }
    {
        c2 = theory.createUpgrade(4, currency, new ExponentialCost(15, 2.5));
        c2.getDescription = (_) => "\beta = " + getBeta(c2.level).toFixed(3);
        c2.getInfo = (amount) => "\beta: " + getBeta(c2.level).toFixed(3) + " → " + getBeta(c2.level + amount).toFixed(3);
    }
    ...
    theory.createBuyAllUpgrade(1, currency, 1e15);
    {
        ...
        milestoneResonance.info = "When x/E is between 0.5 and 1.5, the growth rate of x is doubled.";
    ...
    }
    {
        ...
        milestoneEquilibriumBoost.info = "Adds 0.1·log10(x) per second to log10(E).";
    ...
    }
    {
        ...
        milestoneStressFeedback.info = "S gains an additional +0.05·sqrt(D) per second.";
    ...
    }
    {
        ...
        milestoneExplosion.info = "Currency growth is multiplied by 1 + 10·exp(-D).";
